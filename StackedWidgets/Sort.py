...
from Scripts.SortLib import *

def createSort(parent:QWidget):
    ...
    if True:
        ...
        if True:
            ...
            toPG_Main = QPushButton('主界面', Sort)
            toPG_Help = QPushButton('帮助文档', Sort)

            StartRound = QPushButton("开始回合", Sort)
        ...
        StackedWidget = QStackedWidget(Sort)
